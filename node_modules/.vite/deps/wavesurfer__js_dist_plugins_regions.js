...
var o = class _o extends e {
  ...
  addRegion(t2) {
    ...
    return n2 ? this.saveRegion(o2) : this.subscriptions.push(this.wavesurfer.once("ready", (t3) => {
  ...
  enableDragSelection(t2, e2 = 3) {
    ...
    return i(s2, (t3, e3, i2) => {
      ...
      o2 = new r(Object.assign(Object.assign({}, t2), { start: d, end: c }), s3, l), this.regionsContainer.appendChild(o2.element);
    }, () => {
