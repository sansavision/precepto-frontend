import { Check, Inbox, Cpu, SquareDashedKanbanIcon, LayoutTemplate, CircleX, ListStart } from 'lucide-react';
...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  return (
    ...
    >
      ...
      <Sidebar
        collapsible="none"
        className="!w-[calc(var(--sidebar-width-icon)_+_1px)] border-r overflow-y-scroll md:overflow-y-clip"
      >
        <SidebarHeader>
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton size="lg" asChild className="md:h-8 md:p-0">
                ...
                <a href="#" className='flex items-center justify-center'>
                  <div className="flex aspect-square size-16 items-center justify-center rounded-lg  text-sidebar-primary-foreground">
                    ...
                    <img src="/assets/logo4.png" alt="Logo" width="64" height="64" className="rounded-2xl" />
                  </div>
                  <div className="md:!hidden !grid flex-1 text-left text-sm leading-tight">
                ...
                {navMain.map((item) => (
                  <SidebarMenuItem key={item.title}>
                    <SidebarMenuButton
                      ...
                      // className="px-2.5 md:px-2 flex flex-col"
                      className={cx("px-2.5 md:px-2", "md:!flex md:!flex-col", "md:!gap-2 h-20")}
                    >
                      <item.icon size={6} className='!size-6' />
      ...
      <Sidebar  collapsible="none" className="overflow-y-scroll border-t-2">
