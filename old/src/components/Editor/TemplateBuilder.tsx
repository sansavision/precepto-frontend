...
const TemplateBuilder: React.FC<TemplateBuilderProps> = ({ name, description,content, onUpdate, onDelete, template_id }) => {
    ...
    const updateSection = (index: number, sectionData: TemplateSectionData) => {
        console.info("calling update section with sectionData", sectionData)
    ...
    const generateTemplate = () => {
        console.info("section in generateTemplate", sections)
    ...
    const saveTemplate = () => {
        console.info("will store template sections", sections)
